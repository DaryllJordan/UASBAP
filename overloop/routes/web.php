...
Route::get('/admin/tahun', 'App\Http\Controllers\tahunController@index');
Route::get('/admin/tahun/print_pdf', 'App\Http\Controllers\tahunController@print_pdf');
Route::resource('admin/bestseller', 'App\Http\Controllers\Admin\bestsellerController');